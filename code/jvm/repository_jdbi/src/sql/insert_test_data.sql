...
-- USER
insert into user (name, email, password, birth_date, iban, roles)
values
...
-- REFEREE
insert into referee (user_id)
values
    (1), (3), (4);

-- ARBITRATION_COUNCIL
insert into arbitration_council (user_id)
values
    (2), (5);
...
-- CATEGORY_DIR
insert into category_dir (referee_id, id, start_date, end_date, category_id)
values
     (1, 1, '2023-01-01', null, 1),
     (3, 2, '2023-03-01', '2024-01-01', 2);

-- COMPETITION
insert into competition (id, competition_number, name, address, email, phone_number, location, association)
values
...
insert into competition_equipment (competition_id, equipment_id)
values
     (1, 1), (1, 2), (2, 3), (2, 4);

-- CALL_LIST
insert into call_list (deadline, call_type, council_id, competition_id)
values
...
-- MATCH_DAY
insert into match_day (id, match_date, competition_id)
values
...
-- PARTICIPANT
insert into participant (call_list_id, match_day_id, referee_id, role_id, confirmation_status)
values
    (1, 1, 1, 1, 'waiting'),
    (1, 1, 3, 2, 'accepted'),
    (2, 2, 4, 1, 'declined');
...
-- SESSION
insert into session (id, start_time, end_time, match_day_id, competition_id_match_day)
values
    (1, '14:00', '15:30', 1, 1),
    (2, '16:00', '17:30', 2, 2);

-- SESSION_REFEREES
insert into session_referees (session_id, position_id, referee_id, match_day_id_session)
values
    (1, 1, 1, 1),
    (1, 2, 3, 1),
    (2, 1, 4, 2);
...
-- REPORT
insert into report (report_type, competition_id)
values
    ('final', 1),
    ('parcial', 2);
