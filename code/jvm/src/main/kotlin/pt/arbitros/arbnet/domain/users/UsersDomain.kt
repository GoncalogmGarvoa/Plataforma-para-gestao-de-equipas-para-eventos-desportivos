...
class UsersDomain(
    ...
    fun containsDigits(input: String): Boolean = input.any { it.isDigit() }

    fun containsUpperCase(input: String): Boolean = input.any { it.isUpperCase() }

    fun containsLowerCase(input: String): Boolean = input.any { it.isLowerCase() }
}
